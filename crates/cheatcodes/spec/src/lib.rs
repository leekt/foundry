    ...
    pub fn new() -> Self {
        Self {
            ...
            structs: Cow::Owned(vec![
                ...
                Vm::FrameTxFrame::STRUCT.clone(),
                Vm::FrameTxSignature::STRUCT.clone(),
                Vm::FrameTxRecentRootReference::STRUCT.clone(),
                Vm::FrameTxBalanceDiff::STRUCT.clone(),
                Vm::FrameTxStorageDiff::STRUCT.clone(),
                Vm::FrameTxDeployedContract::STRUCT.clone(),
                Vm::FrameTxAccountDiff::STRUCT.clone(),
                Vm::FrameTxEvent::STRUCT.clone(),
                Vm::FrameTxTrace::STRUCT.clone(),
                Vm::FrameTx::STRUCT.clone(),
